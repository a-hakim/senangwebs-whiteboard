...
__webpack_require__.d(__webpack_exports__, {
  SWWInstance: () => (/* binding */ SWWInstance)
});

;// ./src/js/modules/utils/SpatialIndex.js
/**
...
;// ./src/js/modules/utils/constants.js
/**
 ...
 */
const PERFORMANCE_THRESHOLDS = (/* unused pure expression or super */ null && ({
...
;// ./src/js/modules/core/SWWInstance.js
/**
...
// EXTERNAL MODULE: ./src/js/modules/core/SWWInstance.js + 2 modules
var SWWInstance = __webpack_require__(638);
;// ./src/js/modules/utils/PerformanceUtils.js
/**
...
;// ./src/js/modules/core/initialization.js
/**
...
const InitializationMixin = {
  ...
  isElementInBounds(elementBounds, viewBounds) {
    return !(elementBounds.x > viewBounds.x + viewBounds.width || elementBounds.x + elementBounds.width < viewBounds.x || elementBounds.y > viewBounds.y + viewBounds.height || elementBounds.y + elementBounds.height < viewBounds.y);
  }
};
;// ./src/js/modules/core/elementManagement.js
/**
 * Element Management Mixin for SWWInstance
 * Handles adding, removing, and updating elements in the scene
 */

const ElementManagementMixin = {
  /**
  ...
  getLevelOfDetail(element) {
    const elementSize = Math.max(Math.abs(element.width || 0), Math.abs(element.height || 0));
...
;// ./src/js/modules/core/SceneState.js
const SCENE_VERSION = 1;
const ELEMENT_TYPES = new Set(["rectangle", "ellipse", "diamond", "parallelogram", "star", "line", "arrow", "path", "text", "website", "image", "markdown", "table"]);
const RUNTIME_ELEMENT_KEYS = new Set(["svgElement", "boundaryRect", "pendingBoundaryRect", "_mouseDownHandler", "_touchStartHandler", "dragStartX", "dragStartY", "resizeStartX", "resizeStartY", "resizeStartWidth", "resizeStartHeight", "rotateStartAngle"]);
...
function normalizeElement(rawElement, generateId) {
  ...
  element.strokeColor = typeof element.strokeColor === "string" ? element.strokeColor : "#000000";
  element.fillColor = typeof element.fillColor === "string" ? element.fillColor : "#ffffff";
  element.fillStyle = typeof element.fillStyle === "string" ? element.fillStyle : "solid";
  element.fontFamily = typeof element.fontFamily === "string" ? element.fontFamily : "Arial";
  element.textAlign = typeof element.textAlign === "string" ? element.textAlign : "left";
  element.textColor = typeof element.textColor === "string" ? element.textColor : "#000000";
...
const SceneStateMixin = {
  ...
  createSceneSnapshot({
    ...
    return {
      ...
      selectedElementIds: includeSelection ? Array.from(this.selectedElements, element => element.id) : []
    };
  },
  getScene() {
  ...
  validateScene(sceneData) {
    ...
    return {
      ...
      backgroundColor: typeof sceneData.backgroundColor === "string" ? sceneData.backgroundColor : this.options.backgroundColor,
      gridSize: Math.max(1, finiteNumber(sceneData.gridSize, this.options.gridSize)),
      showGrid: sceneData.showGrid === undefined ? this.snapToGrid : Boolean(sceneData.showGrid),
      selectedElementIds: Array.isArray(sceneData.selectedElementIds) ? sceneData.selectedElementIds.filter(id => typeof id === "string") : []
    };
  },
  ...
  loadScene(sceneData) {
    this.applySceneSnapshot(sceneData, {
      actionType: "loadScene"
    });
    return true;
  }
...
;// ./src/js/modules/canvas/CanvasMixin.js
/**
...
;// ./src/js/modules/ui/ToolbarMixin.js
/**
...
;// ./src/js/modules/core/eventHandlers.js
/**
...
const EventHandlersMixin = {
  ...
  handleKeyDown(e) {
    ...
    const isEditingInput = activeElement && (activeElement.tagName === 'INPUT' || activeElement.tagName === 'TEXTAREA' || activeElement.tagName === 'SELECT' || activeElement.contentEditable === 'true');
...
const ToolManagerMixin = {
  ...
  setTool(toolName) {
    // Validate tool name
    const validTools = ['select', 'rectangle', 'ellipse', 'diamond', 'parallelogram', 'star', 'arrow', 'line', 'text', 'draw', 'website', 'image', 'markdown', 'table'];
...
;// ./src/js/modules/tools/LineToolsMixin.js
/**
 * LineToolsMixin.js
 * Handles drawing of line and arrow elements
 */

const LineToolsMixin = {
  /**
...
;// ./src/js/modules/tools/TextTool.js
/**
 * TextTool.js
  ...
  startTextEditing(element) {
    ...
    handleClickOutside = e => {
      if (!textEditor.contains(e.target) && textEditor.parentNode) {
        const isToolbarClick = e.target.closest('.sww-toolbar') || e.target.closest('button') || e.target.classList.contains('sww-toolbar-button');
        if (!isToolbarClick) {
          finishEditing();
          document.removeEventListener('click', handleClickOutside);
        }
...
;// ./src/js/modules/tools/DrawTool.js
/**
...
const DrawToolMixin = {
  ...
  finalizePathElement(element) {
    ...
    element.points = this.convertPointsToRelative(element.points, bounds.minX, bounds.minY);
  }
};
;// ./src/js/modules/utils/security.js
const ALLOWED_TAGS = new Set(["a", "b", "blockquote", "br", "code", "del", "em", "h1", "h2", "h3", "h4", "h5", "h6", "hr", "i", "li", "ol", "p", "pre", "s", "span", "strong", "table", "tbody", "td", "th", "thead", "tr", "u", "ul"]);
...
function sanitizeUrl(value, {
  ...
  if (allowDataImages && /^data:image\/(?:png|jpeg|gif|webp);base64,[a-z0-9+/=\s]+$/i.test(candidate)) {
    return candidate;
  }
  try {
...
;// ./src/js/modules/tools/EmbedToolsMixin.js
...
const EmbedToolsMixin = {
  ...
  updateWebsiteSVG(element) {
    ...
    if (element.url && element.url.trim()) {
      ...
      iframe.setAttribute("sandbox", this.options.iframeSandbox || "allow-forms allow-popups allow-scripts");
      ...
      div.innerHTML = '<i class="ss ss-globe-alt"></i><br>Double-click to set URL';
      svg.appendChild(div);
    }
  },
  /**
  ...
  updateImageSVG(element) {
    ...
    if (element.imageUrl && element.imageUrl.trim()) {
      ...
      img.src = sanitizeUrl(element.imageUrl, {
      ...
      div.style.height = "100%";
      this.applyStrokeAndFillToContainer(div, element);
      div.innerHTML = '<i class="ss ss-photo"></i><br>Double-click to set image';
      svg.appendChild(div);
    }
  },
  /**
  ...
  parseMarkdownInternal(text) {
    ...
    if (typeof marked !== "undefined") {
      try {
        ...
        marked.setOptions({
          breaks: true,
          // Support single line breaks
          gfm: true,
          // GitHub flavored markdown
          sanitize: false,
          // We'll trust the input since it's user content
          smartLists: true,
...
;// ./src/js/modules/tools/TableTool.js
/**
...
;// ./src/js/modules/selection/SelectionManager.js
/**
...
;// ./src/js/modules/selection/SelectionBox.js
/**
...
const SelectionBoxMixin = {
  ...
  isElementInSelectionBox(element, boxX, boxY, boxWidth, boxHeight) {
    ...
    const noIntersection = bounds.x > boxX + boxWidth ||
...
;// ./src/js/modules/selection/SelectionHandles.js
/**
...
const SelectionHandlesMixin = {
  ...
  isPointNearRotateHandle(point, tolerance = 5) {
    ...
    const distance = Math.sqrt(Math.pow(point.x - rotateHandleX, 2) + Math.pow(point.y - rotateHandleY, 2));
  ...
  getHandleAtPoint(point, tolerance = 5) {
    ...
    for (const handle of handles) {
      if (handle.tagName === 'rect') {
        ...
        if (point.x >= x - tolerance && point.x <= x + width + tolerance && point.y >= y - tolerance && point.y <= y + height + tolerance) {
...
;// ./src/js/modules/selection/ElementManipulation.js
/**
...
const ElementManipulationMixin = {
  /**
  ...
  updateElementDrag(point) {
    ...
    const shouldSnapDrag = this.snapToGrid && selectedElements.some(element => element.type !== 'path');
  ...
  startResize(handleType, point) {
    ...
    this.selectedElements.forEach(element => {
      ...
      if (element.type === 'text') {
        ...
        element.resizeStartPoints = element.points ? element.points.map(p => ({
          x: p.x,
          y: p.y
        })) : [];
      }
  ...
  updateResize(point) {
    ...
    this.selectedElements.forEach(element => {
      ...
      if (element.type === 'line' || element.type === 'arrow') {
        ...
        switch (this.resizeHandle) {
          case 'se':
            // Southeast - scale from NW origin
            scaleX = (startWidth + dx) / startWidth;
            scaleY = (startHeight + dy) / startHeight;
            break;
          case 'nw':
            // Northwest - scale from SE origin
            scaleX = (startWidth - dx) / startWidth;
            scaleY = (startHeight - dy) / startHeight;
            break;
          case 'ne':
            // Northeast - scale from SW origin
            scaleX = (startWidth + dx) / startWidth;
            scaleY = (startHeight - dy) / startHeight;
            break;
          case 'sw':
            // Southwest - scale from NE origin
            scaleX = (startWidth - dx) / startWidth;
            scaleY = (startHeight + dy) / startHeight;
            break;
          default:
        ...
        switch (this.resizeHandle) {
          case 'se':
            // Southeast - origin stays at NW
            // No position change needed
            break;
          case 'nw':
            // Northwest - origin moves, SE corner stays fixed
            newX = startX + startWidth - newWidth;
            newY = startY + startHeight - newHeight;
            break;
          case 'ne':
            // Northeast - origin moves vertically, SW corner stays fixed
            newY = startY + startHeight - newHeight;
            break;
          case 'sw':
            // Southwest - origin moves horizontally, NE corner stays fixed
            newX = startX + startWidth - newWidth;
            break;
        }
        ...
        switch (this.resizeHandle) {
          case 'se':
            // Southeast handle - works for all elements
            newWidth = startWidth + dx;
            newHeight = startHeight + dy;
            break;
          case 'sw':
          ...
          case 'n':
            ...
            break;
          case 's':
            // South handle - adjust height only
            newHeight = startHeight + dy;
            break;
        }
...
;// ./src/js/modules/ui/PropertiesPanel.js
/**
 * PropertiesPanel.js
...
const PropertiesPanelMixin = {
  ...
  createPropertiesPanel() {
    ...
    Promise.resolve(/* import() */).then(__webpack_require__.bind(__webpack_require__, 638)).then(module => {
  ...
  updateTextPropertiesVisibility() {
    ...
    const hasMarkdownElements = Array.from(this.selectedElements).some(element => element.type === "markdown");
    const hasImageElements = Array.from(this.selectedElements).some(element => element.type === "image");
    const hasWebsiteElements = Array.from(this.selectedElements).some(element => element.type === "website");
  ...
  updateGradientControlsVisibility() {
    ...
    if (this.selectedElements.size > 0) {
      ...
      isGradientStyle = Array.from(this.selectedElements).some(element => element.fillStyle === "gradient");
    } else {
  ...
  createGradientStopElement(stop, index) {
    ...
    const gradientStops = this.selectedElements.size === 1 ? Array.from(this.selectedElements)[0].gradientStops || this.toolSettings.gradientStops : this.toolSettings.gradientStops;
  ...
  removeGradientStop(index) {
    ...
    let gradientStops = this.selectedElements.size === 1 ? Array.from(this.selectedElements)[0].gradientStops || this.toolSettings.gradientStops : this.toolSettings.gradientStops;
...
;// ./src/js/modules/ui/LayersPanel.js
/**
 * LayersPanel.js
...
const LayersPanelMixin = {
  ...
  getLayerName(element) {
    if (element.text) {
      return `Text: ${element.text.substring(0, 20)}${element.text.length > 20 ? "..." : ""}`;
    }
    if (element.url) {
      return `Website: ${element.url.substring(0, 20)}${element.url.length > 20 ? "..." : ""}`;
    }
    if (element.src) {
      return `Image: ${element.src.substring(0, 20)}${element.src.length > 20 ? "..." : ""}`;
    }
  ...
  moveElementForward(elementId) {
    ...
    if (element.svgElement && element.svgElement.parentNode) {
      ...
      if (nextElement.svgElement) {
        element.svgElement.parentNode.insertBefore(element.svgElement, nextElement.svgElement.nextSibling);
      }
    }
    this.saveStateToHistory("reorder");
  ...
  moveElementBackward(elementId) {
    ...
    if (element.svgElement && element.svgElement.parentNode) {
      ...
      if (prevElement.svgElement) {
        element.svgElement.parentNode.insertBefore(element.svgElement, prevElement.svgElement);
      }
    }
    this.saveStateToHistory("reorder");
  ...
  duplicateElement(elementId) {
    ...
    // Generate new ID
    duplicate.id = `${element.type}-${Date.now()}-${Math.random().toString(36).substr(2, 9)}`;
  ...
  ungroupSelectedElements() {
    ...
    const hasGroupedElements = Array.from(this.selectedElements).some(el => el.groupId);
...
;// ./src/js/modules/ui/ExportDialog.js
/**
 * ExportDialog.js
...
const ExportDialogMixin = {
   ...
   */
  exportToPNG(options = {}) {
    const unsupportedElement = this.elements.find(element => element.visible !== false && element.type === "website");
    if (unsupportedElement) {
      this.showNotification?.("PNG export does not support live website embeds. Use SVG or hide the embed.", "warning");
      return false;
    }
    ...
    if (crossOriginImage) {
      this.showNotification?.("PNG export requires same-origin or embedded image data.", "warning");
      return false;
    }
...
;// ./src/js/modules/ui/ControlPanel.js
/**
 * ControlPanel.js
...
;// ./src/js/modules/history/History.js
/**
 * History.js
...
const HistoryMixin = {
  ...
  saveStateToHistory(actionType) {
    ...
    this.updateHistoryButtons();
    this.emitSceneChanged(actionType, Array.from(this.selectedElements, element => element.id));
  },
  /**
   * Undo last action
   */
...
;// ./src/js/modules/viewport/Viewport.js
/**
 * Viewport.js
...
const ViewportMixin = {
   ...
   */
  isPointVisible(x, y) {
    return x >= this.viewBox.x && x <= this.viewBox.x + this.viewBox.width && y >= this.viewBox.y && y <= this.viewBox.y + this.viewBox.height;
  },
  /**
   * Get viewport bounds
...
;// ./src/js/modules/clipboard/Clipboard.js
/**
 * Clipboard.js
...
const ClipboardMixin = {
  ...
  cutSelected() {
    ...
    this.deleteSelected();
    if (this.showNotification) {
      this.showNotification(`Cut ${this.clipboard.length} element${this.clipboard.length > 1 ? 's' : ''}`, 'copy');
    }
  },
  /**
   * Paste elements from clipboard
  ...
  duplicateSelected() {
    ...
    if (this.showNotification) {
      this.showNotification(`Duplicated ${duplicates.length} element${duplicates.length > 1 ? 's' : ''}`, 'paste');
    }
    this.updateControlPanelLayers();
    return duplicates;
  },
...
;// ./src/js/modules/contextmenu/ContextMenu.js
/**
 * ContextMenu.js
...
const ContextMenuMixin = {
  ...
  updateContextMenuState() {
    ...
    const hasEditableSelection = Array.from(this.selectedElements).some(el => el.type === "text" || el.type === "website" || el.type === "image" || el.type === "markdown");
...
;// ./src/js/modules/actions/ElementActions.js
/**
 * ElementActions.js
...
const ElementActionsMixin = {
  ...
  sendToBack() {
    ...
    elementsToMove.reverse().forEach(({
      element
    }) => {
      this.elements.unshift(element);
    });
  ...
  editSelected() {
    ...
    const editableElement = Array.from(this.selectedElements).find(el => el.type === 'text' || el.type === 'website' || el.type === 'image' || el.type === 'markdown');
    if (editableElement) {
...
;// ./src/js/modules/dialogs/Dialogs.js
/**
 * Dialogs.js
...
;// ./src/js/modules/utilities/Utilities.js
/**
 * Utilities.js
      ...
      case 'path':
        if (element.points && element.points.length > 0) {
          ...
          const getAbsolutePoint = pathPoint => {
            ...
            return {
              x: pathPoint.x + element.x,
              y: pathPoint.y + element.y
            };
          };
...
function marked_esm_marked(src, opt) {
 ...
 */
marked_esm_marked.options =
    marked_esm_marked.setOptions = function (options) {
        markedInstance.setOptions(options);
        marked_esm_marked.defaults = markedInstance.defaults;
        changeDefaults(marked_esm_marked.defaults);
        return marked_esm_marked;
    };
/**
 * Gets the original marked default options.
 */
marked_esm_marked.getDefaults = _getDefaults;
marked_esm_marked.defaults = _defaults;
/**
 * Use Extension
 */
marked_esm_marked.use = function (...args) {
 ...
 * Run callback for every token
 */
marked_esm_marked.walkTokens = function (tokens, callback) {
 ...
 */
marked_esm_marked.parseInline = markedInstance.parseInline;
/**
 * Expose
 */
marked_esm_marked.Parser = _Parser;
marked_esm_marked.parser = _Parser.parse;
marked_esm_marked.Renderer = _Renderer;
marked_esm_marked.TextRenderer = _TextRenderer;
marked_esm_marked.Lexer = _Lexer;
marked_esm_marked.lexer = _Lexer.lex;
marked_esm_marked.Tokenizer = _Tokenizer;
marked_esm_marked.Hooks = _Hooks;
marked_esm_marked.parse = marked_esm_marked;
const options = marked_esm_marked.options;
const setOptions = marked_esm_marked.setOptions;
const use = marked_esm_marked.use;
const walkTokens = marked_esm_marked.walkTokens;
const parseInline = marked_esm_marked.parseInline;
const parse = (/* unused pure expression or super */ null && (marked_esm_marked));
...
const SVGRendererMixin = {
  ...
  createCSSGradient(element) {
    ...
    const colorStops = stops.sort((a, b) => a.offset - b.offset) // Sort by offset
    .map(stop => `${stop.color} ${stop.offset}%`).join(", ");
  ...
  parseMarkdown(text) {
    ...
    // Use marked.js library for parsing markdown
    if (typeof marked_esm_marked !== "undefined") {
      try {
        // Marked parses markdown; sanitizeHtml enforces the rendering policy.
        marked_esm_marked.setOptions({
          breaks: true,
          // Support single line breaks
          gfm: true,
          // GitHub flavored markdown
        ...
        return sanitizeHtml(marked_esm_marked.parse(text));
      } catch (error) {
...
const ThemeManagerMixin = {
  ...
  applyThemeColors() {
    ...
    const panels = [this.propertiesPanel, this.layersPanel, this.exportDialog].filter(Boolean);
...
Object.assign(SWWInstance.SWWInstance.prototype, InitializationMixin);
Object.assign(SWWInstance.SWWInstance.prototype, ElementManagementMixin);
Object.assign(SWWInstance.SWWInstance.prototype, SceneStateMixin);
Object.assign(SWWInstance.SWWInstance.prototype, CanvasMixin);
Object.assign(SWWInstance.SWWInstance.prototype, ToolbarMixin);
Object.assign(SWWInstance.SWWInstance.prototype, EventHandlersMixin);
Object.assign(SWWInstance.SWWInstance.prototype, ToolManagerMixin);
Object.assign(SWWInstance.SWWInstance.prototype, ShapeToolsMixin);
Object.assign(SWWInstance.SWWInstance.prototype, LineToolsMixin);
Object.assign(SWWInstance.SWWInstance.prototype, TextToolMixin);
Object.assign(SWWInstance.SWWInstance.prototype, DrawToolMixin);
Object.assign(SWWInstance.SWWInstance.prototype, EmbedToolsMixin);
Object.assign(SWWInstance.SWWInstance.prototype, TableToolMixin);
Object.assign(SWWInstance.SWWInstance.prototype, SelectionToolMixin);
Object.assign(SWWInstance.SWWInstance.prototype, SelectionManagerMixin);
Object.assign(SWWInstance.SWWInstance.prototype, SelectionBoxMixin);
Object.assign(SWWInstance.SWWInstance.prototype, SelectionHandlesMixin);
Object.assign(SWWInstance.SWWInstance.prototype, ElementManipulationMixin);
Object.assign(SWWInstance.SWWInstance.prototype, PropertiesPanelMixin);
Object.assign(SWWInstance.SWWInstance.prototype, LayersPanelMixin);
Object.assign(SWWInstance.SWWInstance.prototype, ExportDialogMixin);
Object.assign(SWWInstance.SWWInstance.prototype, ControlPanelMixin);
Object.assign(SWWInstance.SWWInstance.prototype, HistoryMixin);
Object.assign(SWWInstance.SWWInstance.prototype, ViewportMixin);
Object.assign(SWWInstance.SWWInstance.prototype, ClipboardMixin);
Object.assign(SWWInstance.SWWInstance.prototype, ContextMenuMixin);
Object.assign(SWWInstance.SWWInstance.prototype, ElementActionsMixin);
Object.assign(SWWInstance.SWWInstance.prototype, GridMixin);
Object.assign(SWWInstance.SWWInstance.prototype, DialogsMixin);
Object.assign(SWWInstance.SWWInstance.prototype, UtilitiesMixin);
Object.assign(SWWInstance.SWWInstance.prototype, SVGRendererMixin);
Object.assign(SWWInstance.SWWInstance.prototype, NotificationsMixin);
Object.assign(SWWInstance.SWWInstance.prototype, ThemeManagerMixin);
...
const SWW = {
  ...
  init(container, options = {}) {
    const instance = new SWWInstance.SWWInstance(container, options);
...
/* harmony default export */ const sww = (SWW);
